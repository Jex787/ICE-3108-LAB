...
;MyProject.c,13 :: 		void servoRotate90()
...
;MyProject.c,25 :: 		void servoRotate180()
...
;MyProject.c,39 :: 		TRISB=0;
	CLRF       TRISB+0
;MyProject.c,40 :: 		do
L_main15:
;MyProject.c,42 :: 		servoRotate0();
